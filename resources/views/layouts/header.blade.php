<nav>
    ...
    <ul>
        ...
        <li class="lang">
            @if (App::getLocale() != 'es')
                <a href="{{ route('change_lang', ['lang' => 'es']) }}" onclick="closeMenu()"> <img src='{{ asset('images/idiomas/castellano.png') }}' /></a>
            @endif
            @if (App::getLocale() != 'en')
                <a href="{{ route('change_lang', ['lang' => 'en']) }}" onclick="closeMenu()"><img src='{{ asset('images/idiomas/ingles.png') }}' /></a>
            @endif
            @if (App::getLocale() != 'eu')
                <a href="{{ route('change_lang', ['lang' => 'eu']) }}" onclick="closeMenu()"><img src='{{ asset('images/idiomas/euskera.png') }}' /></a>
            @endif
        </li>
    </ul>
</nav>
