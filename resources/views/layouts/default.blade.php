...
<html lang="{{ App::getLocale()}}">
    ...
    <body>
        ...
        <div id="video-intro">
            <video playsinline preload="auto" autoplay loop muted class="fillWidth fadeIn wow in" data-wow-delay="0.5s" poster="{{ asset('images/posiciones-karate.jpg') }}" id="video-background" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
