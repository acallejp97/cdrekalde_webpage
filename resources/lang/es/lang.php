...
return [
    ...
    */
    ...
    'karate-joven' => 'Karate Joven',
    'karate-adulto' => 'Karate Adulto',
    'aikido' => 'Aikido',
    'kickboxing' => 'Kick Boxing',
    'pilates' => 'Pilates',
    'defensapersonal' => 'Defensa Personal',
    ...
    'description-kickboxing' => 'Deporte de combate en el que mezclamos lo mejor de algunas artes marciales, como el Boxeo, Karate y Muay-Thay. Un deporte muy completo para practicar de forma amateur o con vistas a superarte personalmente.',
    'description-pilates' => 'Es un sistema de entrenamiento físico y mental, creado de distintas especialidades como la gimnasia, traumatología y yoga. El método ayuda a mantener el equilibrio corporal y dar estabilidad y firmeza a la columna vertebral, ideal como terapia en rehabilitación.',
    'description-defensapersonal' => 'La defensa personal es un conjunto de habilidades técnico-tácticas encaminadas a impedir o repeler una agresión, realizadas por uno mismo y para sí mismo.</br></br>También recibe otras denominaciones como autoprotección o seguridad personal, no obstante estos conceptos tienen un ámbito mayor, donde destaca fundamentalmente el componente preventivo.',
